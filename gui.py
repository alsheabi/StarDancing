...
class GUI():
    ...
    def __init__(self, quads):
        ...
        self.fig.canvas.manager.set_window_title('StarDancing')
    ...
    def init_plot(self):
        for key in self.quads:
            self.quads[key]['l1'], = self.ax.plot([],[],[],color='blue',linewidth=1,antialiased=False)
            self.quads[key]['l2'], = self.ax.plot([],[],[],color='red',linewidth=1,antialiased=False)
            self.quads[key]['hub'], = self.ax.plot([],[],[],marker='o',color='green', markersize=3,antialiased=False)
